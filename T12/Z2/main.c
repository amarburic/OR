...
int main() {
	FILE *ulaz;
	char znak, ime[20];
	int broj_redova=0, broj_rijeci=0, broj_znakova=0, 
	broj_samoglasnika=0, broj_velikih_slova=0, broj_cifara=0, razmak=1;
...
broj_samoglasnika, broj_velikih_slova, broj_cifara);
	fclose (ulaz);
	return 0;
}